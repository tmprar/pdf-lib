...
var _PDFContext = class _PDFContext {
  ...
  flateStream(contents, dict = {}) {
    return this.stream(pako2.deflate(typedArrayFor(contents)), {
      ...dict,
      Filter: "FlateDecode"
    });
  }
...
var _StandardFontEmbedder = class _StandardFontEmbedder {
  constructor(fontName, customName) {
    ...
    this.encoding = fontName === FontNames2.ZapfDingbats ? Encodings.ZapfDingbats : fontName === FontNames2.Symbol ? Encodings.Symbol : Encodings.WinAnsi;
